...
public class EnergyOutletFragment extends Fragment {

    private EnergyOutletViewModel sendViewModel;
    ...
    public EnergyOutletFragment() {}

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        sendViewModel =
                ViewModelProviders.of(this).get(EnergyOutletViewModel.class);
